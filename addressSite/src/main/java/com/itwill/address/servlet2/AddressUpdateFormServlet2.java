...
@WebServlet("/address_update_form2.do")
public class AddressUpdateFormServlet2 extends HttpServlet {
	@Override
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			...
			out.println("	</div>");
			out.println("	<form method='post' action='address_update_action2.do'>");
