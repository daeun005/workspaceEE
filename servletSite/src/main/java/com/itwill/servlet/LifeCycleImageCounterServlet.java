...
public class LifeCycleImageCounterServlet extends HttpServlet {
	...
	protected void service(HttpServletRequest request, HttpServletResponse response)
		...
		out.println("<br/>");
		out.println("		현재까지의 페이지뷰수 <font color=#0000FF>"+ "<img src='images/"+count+".png'>" + "</font> 번입니다");
		out.println("	</center>");
		out.println("</body>");
		out.println("</html>");
	}
	...
	/*
	 * count -> 이미지로 바꾸는 메소드 만들어야만
	 * 1에 <img src='images/1.png'> 대입
	 * 2에 <img src='images/2.png'> 대입
	 * 어떻게하라고. . .
	 */
